...
<div style="width:470px; height:auto; margin:auto;" id="banners">
    ...
    if (mysql_num_rows($tops) == '0') {
        ...
        while ($row = mysql_fetch_array($tops)) {
            if ($row["id"] == '1') {
                $link = "http://www.topservers200.com";
                @$site = fopen($link, "r");
                if ($site) {
            ...
            if ($row["id"] == '2') {
                ...
                if (checkOnline($link)) {
                    @header('Content-Type: text/html; charset=utf-8');
                    $userIP = getUserIP();//$_SERVER['REMOTE_ADDR']; 
                    $xml_string = acessoSimples("http://top.l2jbrasil.com/votesystem/?ip={$userIP}&username={$row['top_id']}");
                    ...
                    $data2 = strtotime($data_hoje);
//                    var_dump($xml_string,$data1 >= $data2, $data1, $data2);
//                    exit;
                    if ($data1 >= $data2) {
                        $id2 = '1';
            ...
            if ($row["id"] == '3') {
                $link = "http://www.gamesites200.com";
                @$site = fopen($link, "r");
                if ($site) {
                    ...
                    if ($pagina[130] == '0') {
                        ...
                        $id3 = '1';
                        while ($voto3 = mysql_fetch_array($checa_gs200)) {
                            $data3 = $voto3["data_voto_id3"];
                        }
        ...
        if ($row["id"] == '7') {
            $link = "http://www.mmorpgtoplist.com";
            @$site = fopen($link, "r");
            if ($site) {
        ...
        if ($row["id"] == '11') {
            ...
            if ($row["id"] == '12') {
                $link = "http://www.top200games.com.br";
                @$site = fopen($link, "r");
                if ($site) {
                    @header('Content-Type: text/html; charset=utf-8');
    ...
    if ($id1 == 1 and $xml1) {
        $contador1 = 'atualizaContador1();';
    } else {
        $contador1 = '';
    }
    if ($id2 == 1 and $xml2) {
        $contador2 = 'atualizaContador2();';
    } else {
        $contador2 = '';
    }
    if ($id3 == 1 and $pagina) {
        $contador3 = 'atualizaContador3();';
    } else {
        $contador3 = '';
    }
    if ($id4 == 1 and $xml4) {
        $contador4 = 'atualizaContador4();';
    } else {
        $contador4 = '';
    }
    if ($id5 == 1) {
        $contador5 = 'atualizaContador5();';
    } else {
        $contador5 = '';
    }
    if ($id6 == 1) {
        $contador6 = 'atualizaContador6();';
    } else {
        $contador6 = '';
    }
    if ($id7 == 1) {
        $contador7 = 'atualizaContador7();';
    } else {
        $contador7 = '';
    }
    if ($id8 == 1) {
        $contador8 = 'atualizaContador8();';
    } else {
        $contador8 = '';
    }
    if ($id9 == 1) {
        $contador9 = 'atualizaContador9();';
    } else {
        $contador9 = '';
    }
    if ($id10 == 1) {
        $contador10 = 'atualizaContador10();';
    } else {
        $contador10 = '';
    }
    if ($id11 == 1) {
        $contador11 = 'atualizaContador11();';
    } else {
        $contador11 = '';
    }
    if ($id12 == 1) {
        $contador12 = 'atualizaContador12();';
    } else {
        $contador12 = '';
    }
                        ...
                        if (strtotime($rows["data_voto_id1"]) == strtotime($data_modificada1) and $rows["data_voto_id1"] != '0000-00-00 00:00:00') {
                            ...
                            if (mysql_num_rows($chars) == '1') {
                                if (count($moeda_voto) == '0' || count($qtd_moeda_voto) == '0') {
                                    ...
                                    if ($moeda_votos != ',') {
                                        $moeda_voto = $moeda_voto . ",";
                                    }
                                    if ($qtd_moeda_votos != ',') {
                                        $qtd_moeda_voto = $qtd_moeda_voto . ",";
                                    }
                                    ...
                                    for ($x = 0; $x < (count($moeda_voto) - 1); $x++) {
                                        ...
                                        if (mysql_num_rows($busca_item) == '0') {
                                            ...
                                            while ($rrow = mysql_fetch_array($busca_item)) {
                                                $qtd_existente = $rrow["$col_item_count"] + $qtd_moeda_voto[$x];
                                            }
